...
A researcher can realize the greatest advantage of using the
@BraunDamien2015 method when estimating posterior distributions of
hierarchical models.  In this note, we present an example of such a
model, and explain how to estimate it.  The topics are:
